...
export default function FloatingCTA() {
  ...
  return (
    <>
      {/* WhatsApp / Contact Bubble — bottom-right */}
      <button
        onClick={() => setIsModalOpen(true)}
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-2xl hover:bg-green-600 transition-all hover:scale-105"
